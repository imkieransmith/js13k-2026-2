...
async function buildShadowGame(encodedLevels) {
  ...
  await Promise.all([
    ...
    cp('src/arena.js', `${root}/src/arena.js`),
    cp('src/style.css', `${root}/src/style.css`),
    writeFile(`${root}/src/levels/arena.json`, '{}\n'),
